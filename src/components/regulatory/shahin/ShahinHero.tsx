  ...
  return (
    <>
      <style>{`
        ...
        .shn-glow { position: absolute; border-radius: 50%; filter: blur(70px); pointer-events: none; z-index: 0; }
        ...
        @media (max-width: 940px) {
          ...
          .shn-hero-cta-row { justify-content: center; }
        }
        ...
        .shn-btn-primary { background: #1360ee; color: #fff; box-shadow: 0 10px 24px rgba(19,96,238,.3); }
        .shn-btn-primary:hover { background: #0d4fd4; transform: translateY(-1px); box-shadow: 0 12px 28px rgba(19,96,238,.4); }
        .shn-btn-ghost { background: #fff; color: #1d1d1f; border: 1.5px solid #e3e3e6; }
        .shn-btn-ghost:hover { border-color: #1360ee; color: #1360ee; transform: translateY(-1px); }
        ...
        .shn-phone-link:hover { color: #1360ee; }
        ...
        .shn-badge-cert { top: -16px; right: 20px; color: #13923f; }
        .shn-badge-stat { bottom: -16px; left: 20px; color: #1360ee; }
        @media (max-width: 560px) {
          .shn-badge { font-size: 11px; padding: 7px 12px; }
        }
      `}</style>

      <section className="shn-hero">
        <div className="shn-glow" style={{ width: 520, height: 420, top: 40, right: '6%', background: 'radial-gradient(60% 60% at 50% 50%, rgba(19,96,238,.09), transparent 72%)' }} />
        ...
        <div className="shn-grid">
          ...
          <div data-reveal="left">
            ...
            <h1 style={{ margin: 0, fontSize: 'clamp(28px,3.8vw,46px)', fontWeight: 800, lineHeight: 1.14, letterSpacing: '-.025em', color: '#1d1d1f' }}>
              <span style={{ color: '#1360ee' }}>SHAHIN:</span> Your Reliable GPS Partner for Seamless Registration
            </h1>

            <p style={{ margin: '18px 0 0', maxWidth: '480px', fontSize: 'clamp(14px,1.3vw,16px)', lineHeight: 1.65, color: '#52525e' }}>
              Get your fleet SHAHIN-certified with a fully managed GPS tracking solution — SIRA-compliant, installed by certified technicians, and backed by real-time reporting.
            </p>

            <div className="shn-hero-cta-row" style={{ display: 'flex', gap: '14px', marginTop: '28px', flexWrap: 'wrap' }}>
              <Link href="/contact" className="shn-btn shn-btn-primary">Get a Free Quote</Link>
              <Link href="/contact" className="shn-btn shn-btn-ghost">Get Registration Advice</Link>
            </div>

            <a href="tel:+971508746688" className="shn-phone-link" style={{ marginTop: '22px' }}>
          ...
          <div data-reveal="right" style={{ position: 'relative', paddingTop: '20px', paddingBottom: '20px' }}>
            <div className="shn-frame">
              <Image
                src="/hero/web-live-map.png"
                alt="Locator live fleet map — SHAHIN-compliant GPS tracking"
                width={1092}
                height={1000}
            ...
            <span className="shn-badge shn-badge-cert">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20 6L9 17l-5-5" />
              </svg>
              SHAHIN Certified
            </span>
            <span className="shn-badge shn-badge-stat">
