...
export default function GpsTrackerData() {
  return (
    <>
      <style>{`
        .gtd-grid { display: grid; grid-template-columns: 1fr 1fr; gap: clamp(36px,5vw,72px); align-items: center; max-width: var(--w-1160); margin: 0 auto; }
      ...
      <section style={{ padding: 'clamp(56px,7vw,92px) 28px', background: '#f7f9fc' }}>
        <div className="gtd-grid">
          ...
          <div data-reveal="left">
            ...
            <p style={{ margin: '0 0 28px', fontSize: 'max(clamp(13.5px,1.25vw,15px), min(1.042vw, 21.75px))', lineHeight: 1.75, color: '#6e6e73', maxWidth: '50ch' }}>
