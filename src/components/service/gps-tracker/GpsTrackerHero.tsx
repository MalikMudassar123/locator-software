          ...
          <div className="gt-hero-viz" style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
            <div style={{
              ...
              <div className="gt-hero-float" style={{
                ...
                <Image src="/tracking_devices/fmb120.webp" alt="Teltonika GPS tracker device" width={600} height={600} style={{ width: '100%', height: 'auto', display: 'block', position: 'relative', zIndex: 1, filter: 'drop-shadow(0 18px 20px rgba(15,23,42,.16))' }} priority />
              </div>
