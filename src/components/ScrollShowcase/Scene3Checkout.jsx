  ...
  return (
    <svg width="0" height="0" style={{ position:'absolute', overflow:'hidden' }}>
      <defs>
        ...
        <linearGradient id="s3lg0" x1="34" y1="62" x2="498" y2="84" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#f472b6"/><stop offset="100%" stopColor="#06b6d4"/>
        </linearGradient>
        <linearGradient id="s3lg1" x1="34" y1="130" x2="34" y2="280" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#8b5cf6"/><stop offset="100%" stopColor="#3b82f6"/>
        </linearGradient>
        <linearGradient id="s3lg2" x1="68" y1="314" x2="321" y2="299" gradientUnits="userSpaceOnUse">
  ...
  return (
    ...
    >
      ...
      <svg width={W} height={H} viewBox={`0 0 ${W} ${H}`}
        ...
        {CONNECTIONS.map((d, i) => (
          <path key={i} ref={el=>(lineRefs.current[i]=el)} d={d}
            stroke={`url(#s3lg${i})`} strokeWidth="1.7" fill="none"
      ...
      <svg width={W} height={H} viewBox={`0 0 ${W} ${H}`}
        ...
        <defs>
          <filter id="s3pgl" x="-5%" y="-4%" width="110%" height="108%">
            <feGaussianBlur stdDeviation="1.8" result="b"/>
            <feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge>
          </filter>
          <filter id="s3bgl" x="-6%" y="-6%" width="112%" height="112%">
            <feGaussianBlur stdDeviation="0.8" result="b"/>
            <feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge>
          </filter>
        </defs>
        <path ref={framePathRef} d={FRAME_PATH}
          stroke="url(#s3pg_w)" strokeWidth="1.2" fill="none"
        ...
        {WIRE.map((d, i) => (
          <path key={i} ref={r=>(wireRefs.current[i]=r)} d={d}
            stroke="url(#s3pg_w)" strokeWidth="0.7" fill="rgba(59,130,246,0.02)"
